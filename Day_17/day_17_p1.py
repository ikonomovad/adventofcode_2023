...
def find_path(grid):
    ...
    while priority_queue:
        ...
        if (row, col, dir_row, dir_col, steps_count) not in visited:
            ...
            # one of the options is to move in other direction, but we cannot go back
            ...
            # other option is to keep going in the same direction until we have 3 steps in line
            if (row, col) != (0, 0):
                if steps_count < 3:
