...
# The `@cache` decorator is used to memoize the function `count_different_arrangements`. Memoization
# is a technique that stores the results of expensive function calls and returns the cached result
# when the same inputs occur again. This can greatly improve the performance of the function by
# avoiding redundant calculations. The `@cache` decorator is available in Python 3.9 and above, and it
# automatically handles the caching of function results based on the function arguments.
